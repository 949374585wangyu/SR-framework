 ...
 * @Last Modified time: 2019-06-14 12:09:52 
 * @Desc: 
'''
import torch
import math
...
# def Loss(opt):
#     for loss in opt.loss

def make_optim(opt, parameters):
    ...
    else: optimizer = optim.RMSprop(parameters, lr=opt.lr, alpha=0.9)
