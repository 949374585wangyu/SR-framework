...
'''
 * @Author: wjm 
 * @Date: 2019-06-14 13:51:24 
 * @Last Modified by:   wjm 
 * @Last Modified time: 2019-06-14 13:51:24 
 * @Desc: 
'''
...
parser.add_argument('--test_dataset', type=str, default='LR')
parser.add_argument('--residual', type=bool, default=False)
parser.add_argument('--model', default='weights/Nettpami_residual_filter8_epoch_1.pth', help='sr pretrained base model')
...
model = net(num_channels=3, base_filter=64, num_stages=7, scale_factor=opt.upscale_factor)
